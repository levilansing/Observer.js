...
(function($) {
	...
	/**
	 * Register to listen for a single event one time
	 * @param target the context of `this` for the callbacks
	 * @param {string} event the name of the event we want to listen for
	 * @param {function()} handler
	 */
	Observer.prototype.listenForEventOnce = function(target, event, handler) {
		var self = this;
		(function() {
			self.listenForEvent(this, event, function() {
				self.stopListeningForEvent(this, event);
